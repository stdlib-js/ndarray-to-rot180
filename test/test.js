...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof toRot180, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns a new ndarray containing a matrix rotated 180 degrees (ndims=2)', function test( t ) {
	var expected;
	var actual;
	var buf;
	var ord;
...
tape( 'rotating twice in the same plane returns the original arrangement', function test( t ) {
	var expected;
	var actual;
	var buf;
	var ord;
